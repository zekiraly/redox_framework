...
class Dataset(object):
    def __init__(self, dataset, batch=128, mean=None, std=None, max_atoms=0):
    ...
    def save_dataset(self, path, pred=None, filename=None):
        mols = []
        for idx, (x, c, y) in enumerate(zip(self.x, self.c, self.y)):
    ...
    def generator(self, task=None):
        return MPGenerator(self.x, self.c, self.y, self.batch,
